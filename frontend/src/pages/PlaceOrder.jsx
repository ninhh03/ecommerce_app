...
const PlaceOrder = () => {
  ...
  return (
    <div className="flex flex-col sm:flex-row justify-between gap-4 pt-5 sm:pt-14 min-h-[80vh] border-t border-gray-200">
      {/* Left side */}
      <form action="" className="flex flex-col gap-4 w-full sm:max-w-[480px]">
        ...
        <input className="border border-gray-300 rounded py-1.5 px-3.5 w-full" type="text" name="" id="" placeholder="Street" />
