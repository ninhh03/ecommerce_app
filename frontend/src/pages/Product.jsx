  ...
  return productData ? (
    <div className="border-t-2 border-gray-200 pt-10 transition-opacity ease-in duration-500 opacity-100">
          ...
          <div className="flex flex-col gap-4 my-8 ">
            ...
            <div className="flex gap-2">
              {productData.sizes.map((item, index) => (
                <button onClick={() => setSize(item)} className={`border py-2 px-4 bg-gray-100 border-gray-200 ${item === size ? "border-orange-500" : ""}`} key={index}>{item}</button>
              ))}
            </div>
          </div>
      ...
      <div className="mt-20">
        ...
        <div className="flex flex-col gap-4 border border-gray-200 px-6 py-6 text-gray-500">
